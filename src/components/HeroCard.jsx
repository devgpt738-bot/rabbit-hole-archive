    ...
    >
      ...
      <div className="relative z-10 p-6 sm:p-10 md:p-16 flex flex-col items-start justify-between min-h-[300px] md:min-h-[400px]">
        ...
        <div className="absolute top-6 right-6 flex items-center gap-3">
          <button 
            onClick={handleCycle}
            className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/20 border border-white/10 hover:border-white/40 flex items-center justify-center text-white/50 hover:text-white transition-all shadow-glass"
          >
            <RefreshCw size={18} />
          </button>
          <button 
            onClick={handleDismiss}
            className="w-10 h-10 rounded-full bg-white/5 hover:bg-crimson-600/40 border border-white/10 hover:border-crimson-neon flex items-center justify-center text-white/50 hover:text-white transition-all shadow-glass"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="max-w-2xl">
          <div className="flex items-center gap-2 mb-6">
            <span className="px-4 py-1.5 text-xs font-sans font-bold tracking-widest uppercase bg-crimson-neon text-black rounded-full shadow-[0_0_15px_#ff4d64]">
              Featured Anomaly
            </span>
            <span className="flex items-center gap-1 text-xs font-sans text-white/50 uppercase tracking-widest">
              <Sparkles size={14} className="text-gold" /> Epic Tier
            </span>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h1 className="font-display text-3xl sm:text-4xl md:text-6xl text-white font-bold leading-none mb-4 sm:mb-6 drop-shadow-[0_5px_15px_rgba(0,0,0,0.8)]">
                {current.title}
              </h1>
              
              <p className="font-sans text-sm sm:text-lg text-white/70 leading-relaxed max-w-xl mb-6 sm:mb-8 drop-shadow-[0_2px_5px_rgba(0,0,0,0.8)]">
                {current.desc}
              </p>
            </motion.div>
          </AnimatePresence>

          <button className="flex items-center gap-3 px-6 py-3 bg-white text-black font-sans font-bold tracking-wider uppercase text-sm rounded-full
